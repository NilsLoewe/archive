...
#navi-outer li.noimages a#fpss-container_playButton {display:block;width:42px;height:16px;background:url(nav-play.png) no-repeat;border:none;float:right;margin:0 4px 0 0;padding:0;}
