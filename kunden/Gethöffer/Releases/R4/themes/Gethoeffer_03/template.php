 ...
 */
function Gethoeffer_03_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Gethoeffer_03_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Gethoeffer_03_button($element) {
...
*/
function Gethoeffer_03_img_assist_page($content, $attributes = NULL) {
