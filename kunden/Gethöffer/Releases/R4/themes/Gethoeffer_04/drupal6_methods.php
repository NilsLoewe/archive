...
function Gethoeffer_04_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Gethoeffer_04_feed_icon($url, $title) {
 ...
 */
function Gethoeffer_04_preprocess_comment_wrapper(&$vars) {
