...
function Gethoeffer_02_regions() {
  return array(
'left' => t('Left sidebar'),
 ...
 * @ingroup themeable
 */
function Gethoeffer_02_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function Gethoeffer_02_feed_icon($url) {
 ...
 */
function Gethoeffer_02_comment_wrapper($content, $type = null) {
  static $node_type;
