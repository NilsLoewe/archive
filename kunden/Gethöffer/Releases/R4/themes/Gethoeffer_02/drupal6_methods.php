...
function Gethoeffer_02_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Gethoeffer_02_feed_icon($url, $title) {
 ...
 */
function Gethoeffer_02_preprocess_comment_wrapper(&$vars) {
