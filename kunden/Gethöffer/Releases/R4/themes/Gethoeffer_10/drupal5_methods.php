...
function Gethoeffer_10_regions() {
  return array(
'left' => t('Left sidebar'),
 ...
 * @ingroup themeable
 */
function Gethoeffer_10_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function Gethoeffer_10_feed_icon($url) {
 ...
 */
function Gethoeffer_10_comment_wrapper($content, $type = null) {
  static $node_type;
