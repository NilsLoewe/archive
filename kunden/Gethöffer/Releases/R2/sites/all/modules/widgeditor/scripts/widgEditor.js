...
widgEditor.prototype.writeDocument = function(documentContent)
{
	...
	{
		documentTemplate = documentTemplate.replace(/INSERT:STYLESHEET:END/, '<link rel="stylesheet" type="text/css" href="' + Drupal.settings.widgeditor.widgContent + '"></link>');
	}
	...
	if (typeof document.all == "undefined")
	{
		...
		stylesheet.setAttribute("href", Drupal.settings.widgeditor.widgContent);
...
function widgToolbarAction()
{
	...
	switch (this.action)
	{
		...
		case "image":
			...
			if (Drupal.settings.widgeditor.imce) {
