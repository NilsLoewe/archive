 ...
 */
function Gethoeffer_02_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Gethoeffer_02_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Gethoeffer_02_button($element) {
...
*/
function Gethoeffer_02_img_assist_page($content, $attributes = NULL) {
