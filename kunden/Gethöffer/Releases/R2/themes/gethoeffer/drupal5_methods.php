 ...
 * @ingroup themeable
 */
function gethoeffer_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function gethoeffer_feed_icon($url) {
 ...
 */
function gethoeffer_comment_wrapper($content, $type = null) {
  static $node_type;
