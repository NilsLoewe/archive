 ...
 */
function gethoeffer_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function gethoeffer_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function gethoeffer_button($element) {
...
*/
function gethoeffer_img_assist_page($content, $attributes = NULL) {
