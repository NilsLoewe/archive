 ...
 */
function Gethoeffer_04_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Gethoeffer_04_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Gethoeffer_04_button($element) {
...
*/
function Gethoeffer_04_img_assist_page($content, $attributes = NULL) {
