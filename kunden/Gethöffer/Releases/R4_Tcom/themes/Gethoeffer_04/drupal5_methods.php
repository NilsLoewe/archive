...
function Gethoeffer_04_regions() {
  return array(
'left' => t('Left sidebar'),
 ...
 * @ingroup themeable
 */
function Gethoeffer_04_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function Gethoeffer_04_feed_icon($url) {
 ...
 */
function Gethoeffer_04_comment_wrapper($content, $type = null) {
  static $node_type;
