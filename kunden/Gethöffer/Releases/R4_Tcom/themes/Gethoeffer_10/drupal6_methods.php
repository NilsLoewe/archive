...
function Gethoeffer_10_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Gethoeffer_10_feed_icon($url, $title) {
 ...
 */
function Gethoeffer_10_preprocess_comment_wrapper(&$vars) {
