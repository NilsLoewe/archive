 ...
 */
function Gethoeffer_10_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Gethoeffer_10_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Gethoeffer_10_button($element) {
...
*/
function Gethoeffer_10_img_assist_page($content, $attributes = NULL) {
