...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { content: @fact.content, link: @fact.link, option_id: @fact.option_id, source: @fact.source, title: @fact.title }
    end
  ...
  test "should update fact" do
    patch :update, id: @fact, fact: { content: @fact.content, link: @fact.link, option_id: @fact.option_id, source: @fact.source, title: @fact.title }
    assert_redirected_to fact_path(assigns(:fact))
  end
